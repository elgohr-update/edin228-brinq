...
const ClientHeader = ({
  ...
  return (
    <div className="flex items-center w-full xl:py-4">
      <div className={`hidden mr-4 xl:flex items-center rounded px-2 text-5xl text-white`}>
        <LineIcon iconSize={25} size="md" line={client?.line} />
      </div>
      <div className={`mr-4 flex xl:hidden items-center rounded px-2 text-5xl text-white`}>
